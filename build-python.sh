...
pip install --user git+https://github.com/TheBrokenRail/python-for-android.git@patch-2 cython
...
PY_LINK=py-build/build/other_builds/python3/${ABI}__ndk_target_${API_LEVEL}/python3/android-build

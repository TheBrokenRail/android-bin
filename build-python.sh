...
pip install --user git+https://github.com/TheBrokenRail/python-for-android.git@patch-4 cython
...
PY_BUNDLE=py-build/dists/build/_python_bundle/

mkdir ${OUT_DIR}/include
cp -r ${PY_INCLUDE}/* ${OUT_DIR}/include
mkdir ${OUT_DIR}/libs
cp ${PY_LIBS}/*.a ${OUT_DIR}/libs

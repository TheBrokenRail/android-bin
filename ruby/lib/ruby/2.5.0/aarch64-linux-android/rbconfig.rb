...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.5.0/aarch64-linux-android")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/travis/build/TheBrokenRail/android-bin/out/ruby' '--host=aarch64-linux-android' 'cflags=-DIOV_MAX=1024 -D_SETKEY_DECLARED' 'host_alias=aarch64-linux-android'"
